...
def process_fast(dataset_root: str, output_root: str, parts_limit: int = 5):
            ...
            try:
                ...
                for orientation, paths in orientations:
                    ...
                    try:
                        ...
                        logger.info(f"    ✓ {len(points_3d)} points, {total_matches} matches")
                ...
                part_result['status'] = 'success' if any(
                    o['status'] == 'success' for o in part_result['orientations'].values()
                ) else 'failed'
    ...
    successful = sum(
        1 for part_data in results['results'].values()
